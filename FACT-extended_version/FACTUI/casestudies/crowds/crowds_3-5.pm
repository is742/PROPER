...
// Model parameters
const double PF1;  // forwarding probability
const double badC1;  // probability that member is untrustworthy

// Probability of forwarding
// const double    PF1 = 0.8;
// const double notPF = 0.2;  // must be 1-PF1

// Probability that a crowd member is bad
// const double  badC1 = 0.1;
// const double  badC1 = 0.091;
// const double  badC1 = 0.167;
// const double goodC = 0.909;  // must be 1-badC1
// const double goodC = 0.833;  // must be 1-badC1
...
const int MaxGood=5;//20; // CWDMAX: maximum number of good crowd members
...
module crowds
	...
	[] !good & !bad & !deliver & run ->
	              1-badC1 : (good'=true) & (recordLast'=true) & (run'=false) +
	               badC1 : (bad'=true)  & (badObserve'=true) & (run'=false);

	// GOOD MEMBERS
	// Forward with probability PF1, else deliver
	[] good & !deliver & run -> PF1 : (good'=false) + 1-PF1 : (deliver'=true);
