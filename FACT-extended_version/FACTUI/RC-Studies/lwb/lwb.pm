...
//B_end
[end] q = 0 -> ps1:(q'=2) + (1-ps1):(q'= 1);

//B_begin
[begin] q = 1 -> 1:(q'=0);

//R_begin
[begin] q = 2 -> ps1:(q'= 3) + (1-ps1):(q'= 0);

//R_end
[end] q = 3 -> ps1:(q'= 4) + (1-ps1):(q'= 1);

//S_begin
[begin] q = 4 -> ps1:(q'= 5) + (1-ps1):(q'= 6) & (m'= 1);

//S_e
[end] q = 5 -> ps1:(q'= 4) + (1-ps1):(q'= 7) & (m'= 1);
	
//M_end
[end] (q = 6) & (m<max_m)  -> ps1:(q'= 4) & (m'= 0) + (1-ps1):(q'= 7) & (m'= m+1);

//M_end_max
[end] (q = 6) & (m>=max_m)  -> ps1:(q'= 4) & (m'= 0) + (1-ps1):(q'= 1) & (m'= 0);

//M_begin
[begin] (q = 7) & (m<max_m)  -> ps1:(q'= 5) & (m' =0) + (1-ps1):(q'= 6) & (m'= m+1);

//M_begin_max
[begin] (q = 7) & (m>=max_m)  -> ps1:(q'= 5) & (m'=0) + (1-ps1):(q'= 0) & (m'= 0);
endmodule
